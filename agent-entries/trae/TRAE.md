...
In the IDE agent flow, pin the selected `SKILL.md` as the task instruction file and open `references/plughub-package-contract.md` before editing package manifests.
